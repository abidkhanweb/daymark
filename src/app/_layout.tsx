...
export default function RootLayout() {
  ...
  return <ThemeProvider value={dark ? DarkTheme : DefaultTheme}><DemoModeProvider><TaskProvider><ExpenseProvider><BackupProvider><AppContent dark={dark} /></BackupProvider></ExpenseProvider></TaskProvider></DemoModeProvider></ThemeProvider>;
}
